...
CREATE TABLE IF NOT EXISTS `accounts` (
  ...
  `nameAccount` varchar(45) NOT NULL ,
...
CREATE TABLE IF NOT EXISTS `characters` (
  ...
  `hp` int(11) DEFAULT  '18',
  `maxHp` int(11) DEFAULT  '18',
  `mana` int(11) DEFAULT  '0',
  `maxMana` int(11) DEFAULT '0',
  `idRaza` int(11) NOT NULL,
  `idGenero` int(11) DEFAULT '1',
  `muerto` int(11) DEFAULT NULL,
  `minHit` int(11) DEFAULT '5',
  `maxHit` int(11) DEFAULT '5',
  ...
  `npcMatados` int(11) NOT NULL DEFAULT '0',
  `ciudadanosMatados` int(11) NOT NULL DEFAULT '0',
  `criminalesMatados` int(11) NOT NULL DEFAULT '0',
  `fianza` int(11) NOT NULL DEFAULT '0',
