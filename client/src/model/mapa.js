export default class Mapa {
  ...
  hayAgua(gridX, gridY) {
    let grh1 = this.getGrh1(gridX, gridY);
    let grh2 = this.getGrh2(gridX, gridY);
  ...
  getGrh(numGrh, gridX, gridY) {
    return this.data.layers[gridX - 1] &&
  ...
  isBajoTecho(gridX, gridY) {
    return this.data.layers[gridX - 1][gridY - 1][5];
  }
