export default {
  ...
  MensajeConsola: {
    ...
    RECHAZO_ATAQUE_ESCUDO: '¡¡¡You have blocked the attack with your shield!!!',
    USUARIO_RECHAZO_ATAQUE_ESCUDO: '¡¡¡The enemy blocked the attack with his shield!!!',
    FALLADO_GOLPE: '¡¡¡You have missed!!!',
    SEGURO_ACTIVADO: '',
    SEGURO_DESACTIVADO: '',
